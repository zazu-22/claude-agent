...
- At least 10% of tests should have 10+ steps each
...
1. Install any required dependencies (`{{init_command}}`)
2. Start any necessary servers or services (`{{dev_command}}`)
3. Print helpful information about how to access the running application

Base the script on the technology stack specified in the project specification.
...
Set up the basic project structure based on what's specified in the project specification.
